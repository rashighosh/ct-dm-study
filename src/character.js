...
export async function alexLookAtJordan() {
  head?.stopGesture(1500)
  head?.playGesture('lookright', Infinity, false, 1500)
}
...
export async function introduceCharacter() {
  head1?.playGesture('introduceCharacter')
}
